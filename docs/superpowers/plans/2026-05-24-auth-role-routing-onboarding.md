...
> Divergence from the verbatim example: extracted a `_wrap` helper, made its
> `MaterialApp` const (analyzer `prefer_const_constructors`), and added two
> responsive checks (375px / 1280px).
